      ...
      <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-if="activeMenu === 'general'" class="space-y-4">
            <h3 class="type-heading text-cockpit-text">General Settings</h3>
          ...
          <div v-if="activeMenu === 'budget'" class="space-y-4">
            <h3 class="type-heading text-cockpit-text">Budget Settings</h3>
            <p class="text-xs text-cockpit-muted">
          ...
          <div v-if="activeMenu === 'about'" class="space-y-4">
            <h3 class="type-heading text-cockpit-text">About CyberPal Cockpit</h3>
